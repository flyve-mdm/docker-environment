...
Welcome to our ever growing community! We are more than happy to accept external contributions to the project in the form of feedback, [translations](http://flyve.org/docker-image/howtos/contribute-translating), bug reports and even better, pull requests!
...
Read our [Contributing guidelines](https://github.com/flyve-mdm/docker-image/blob/develop/CONTRIBUTING.md), you'll learn every step to contribute, from making an issue to closing them, using the [Git Flow](http://git-flow.readthedocs.io/en/latest/), [Conventional Commits](http://conventionalcommits.org/) and the tools we implement.
